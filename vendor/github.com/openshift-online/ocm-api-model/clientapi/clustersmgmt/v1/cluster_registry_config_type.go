...
// permissions.
			...
			// ImageDigestMirrorSets returns the value of the 'image_digest_mirror_sets' attribute, or
			// the zero value of the type if the attribute doesn't have a value.
			//
...
// This is the modern replacement for ImageContentSourcePolicy (ICSP) starting with OpenShift 4.13+.
			func (o *ClusterRegistryConfig) ImageDigestMirrorSets() []*ImageDigestMirrorSet {
				if o != nil && len(o.fieldSet_) > 2 && o.fieldSet_[2] {
					return o.imageDigestMirrorSets
				}
				return nil
			}

			// GetImageDigestMirrorSets returns the value of the 'image_digest_mirror_sets' attribute and
			// a flag indicating if the attribute has a value.
			//
			// ImageDigestMirrorSets contains the configuration for IDMS (ImageDigestMirrorSet)
// which provides digest-based image mirroring functionality for images from non-RH registries.
// This is the modern replacement for ImageContentSourcePolicy (ICSP) starting with OpenShift 4.13+.
			func (o *ClusterRegistryConfig) GetImageDigestMirrorSets() (value []*ImageDigestMirrorSet, ok bool) {
				ok = o != nil && len(o.fieldSet_) > 2 && o.fieldSet_[2]
				if ok {
					value = o.imageDigestMirrorSets
				}
				return
			}

			// ImageTagMirrorSets returns the value of the 'image_tag_mirror_sets' attribute, or
			// the zero value of the type if the attribute doesn't have a value.
			//
...
// This is the modern replacement for ImageContentSourcePolicy (ICSP) starting with OpenShift 4.13+.
			func (o *ClusterRegistryConfig) ImageTagMirrorSets() []*ImageTagMirrorSet {
				if o != nil && len(o.fieldSet_) > 3 && o.fieldSet_[3] {
					return o.imageTagMirrorSets
				}
				return nil
			}

			// GetImageTagMirrorSets returns the value of the 'image_tag_mirror_sets' attribute and
			// a flag indicating if the attribute has a value.
			//
			// ImageTagMirrorSets contains the configuration for ITMS (ImageTagMirrorSet)  
// which provides tag-based image mirroring functionality for images from non-RH registries.
// This is the modern replacement for ImageContentSourcePolicy (ICSP) starting with OpenShift 4.13+.
			func (o *ClusterRegistryConfig) GetImageTagMirrorSets() (value []*ImageTagMirrorSet, ok bool) {
				ok = o != nil && len(o.fieldSet_) > 3 && o.fieldSet_[3]
				if ok {
					value = o.imageTagMirrorSets
				}
				return
			}
