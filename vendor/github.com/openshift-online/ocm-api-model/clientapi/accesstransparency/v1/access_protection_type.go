...
"time"
		...
		// AccessProtectionListKind is the name of the type used to represent list of objects of
		// type 'access_protection'.
		const AccessProtectionListKind = "AccessProtectionList"
		// AccessProtectionListLinkKind is the name of the type used to represent links to list
		// of objects of type 'access_protection'.
		const AccessProtectionListLinkKind = "AccessProtectionListLink"
		// AccessProtectionNilKind is the name of the type used to nil lists of objects of
		// type 'access_protection'.
		...
		func (l *AccessProtectionList) Slice() []*AccessProtection {
			var slice []*AccessProtection
			if l == nil {
				slice = make([]*AccessProtection, 0)
			} else {
				slice = make([]*AccessProtection, len(l.items))
				copy(slice, l.items)
			}
			return slice
		}
