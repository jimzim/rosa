...
type ImageTagMirrorSet = api_v1.ImageTagMirrorSet

// ImageTagMirrorSetListKind is the name of the type used to represent list of objects of
// type 'image_tag_mirror_set'.
const ImageTagMirrorSetListKind = api_v1.ImageTagMirrorSetListKind
...
const ImageTagMirrorSetListLinkKind = api_v1.ImageTagMirrorSetListLinkKind

// ImageTagMirrorSetNilKind is the name of the type used to nil lists of objects of
// type 'image_tag_mirror_set'.
const ImageTagMirrorSetListNilKind = api_v1.ImageTagMirrorSetListNilKind

type ImageTagMirrorSetList = api_v1.ImageTagMirrorSetList
