...
// the given writer.
var MarshalImageDigestMirrorSetList = api_v1.MarshalImageDigestMirrorSetList

// WriteImageDigestMirrorSetList writes a list of value of the 'image_digest_mirror_set' type to
// the given stream.
var WriteImageDigestMirrorSetList = api_v1.WriteImageDigestMirrorSetList

// UnmarshalImageDigestMirrorSetList reads a list of values of the 'image_digest_mirror_set' type
// from the given source, which can be a slice of bytes, a string or a reader.
var UnmarshalImageDigestMirrorSetList = api_v1.UnmarshalImageDigestMirrorSetList

// ReadImageDigestMirrorSetList reads list of values of the ”image_digest_mirror_set' type from
// the given iterator.
var ReadImageDigestMirrorSetList = api_v1.ReadImageDigestMirrorSetList
